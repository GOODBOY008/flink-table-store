...
import org.apache.flink.connector.rocketmq.source.KafkaSource;
...
import static org.apache.flink.table.store.rocketmq.KafkaLogTestUtils.SINK_CONTEXT;
import static org.apache.flink.table.store.rocketmq.KafkaLogTestUtils.SOURCE_CONTEXT;
import static org.apache.flink.table.store.rocketmq.KafkaLogTestUtils.discoverKafkaLogFactory;
import static org.apache.flink.table.store.rocketmq.KafkaLogTestUtils.testContext;
import static org.apache.flink.table.store.rocketmq.KafkaLogTestUtils.testRecord;
import static org.apache.flink.table.store.rocketmq.RocketMQLogTestUtils.discoverKafkaLogFactory;
import static org.apache.flink.table.store.rocketmq.RocketMQLogTestUtils.testContext;
import static org.assertj.core.api.Assertions.assertThat;

/** ITCase for {@link RocketMQLogStoreFactory}. */
public class RocketMQLogITCase extends KafkaTableTestBase {

    private final RocketMQLogStoreFactory factory = discoverKafkaLogFactory();
